...
RUN echo "CREATE DATABASE festivals OWNER spring;" >> /docker-entrypoint-initdb.d/init.sql
RUN echo "GRANT ALL PRIVILEGES ON DATABASE festivals TO spring;" >> /docker-entrypoint-initdb.d/init.sql
